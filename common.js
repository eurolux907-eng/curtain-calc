/* ═══════════════════════════════════════════════════════════════
   ...
   ───────────────────────────────────────────────────────────────
   Сайт состоит из 9 страниц плюс заготовка page-template.html — всего
   10 html-файлов, и common.js подключён в каждом:
       index.html, o-hrame.html, raspisanie.html, svyatyni.html, treby.html,
       tainstva.html, pomoshch.html, kak-nas-naiti.html, voprosy-otvety.html,
       page-template.html
   ...
   КАК ДОБАВИТЬ НОВЫЙ ПУНКТ МЕНЮ
     ...
     3. Продублируйте ссылку в блок <noscript> КАЖДОГО html-файла
        (это запасная навигация для отключённого JavaScript).
     4. Поднимите номер версии ?v= при подключении common.js во ВСЕХ
        html-файлах — см. ниже.
